...
<div align="center"><font color="red"><s:property value="msg"></s:property></font></div>
	<s:form action="reader!add" cssClass="myform" theme="css_xhtml"
		onsubmit="return check(readerid,readerName)">
		<s:textfield key="读者证号" name="readerid" labelposition="left"/>
		<s:textfield key="读者姓名" name="readerName" labelposition="left" />
