...
<s:form  action="user!addUser" cssClass="myform" theme="css_xhtml" onsubmit = "return check(uid,uname,pwd,pwd2)">
		   ...
		   <s:textfield  key="昵称" name="uname" labelposition="left"/>
		    ...
		    <s:select list="#{'读者':'读者','管理员':'管理员'}" name="usertype"  label="用户类型" labelposition="left" listKey="key" listValue="value"  headerKey="1"/>
