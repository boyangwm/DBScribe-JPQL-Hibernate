...
<div align="center"><font color="red"><s:property value="msg"></s:property></font></div>
	<s:form action="book!edit" cssClass="myform" theme="css_xhtml"
		onsubmit="return check(barcode,bookname,price)">
		<s:textfield key="图书条码" name="barcode" readonly="true" labelposition="left" value="%{#editvalue.barcode}"/>
		<s:textfield key="图书名称" name="bookname" labelposition="left" value="%{#editvalue.bookname}"/>
		<s:textfield key="图书单价" name="price" labelposition="left" value="%{#editvalue.price}"/>
