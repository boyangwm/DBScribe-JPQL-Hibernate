...
@WebServlet("/MemberLoginloginServlet")
...
//		String requestURI = (String) request.getAttribute("originalURI");
		System.out.println("MLS requestURI=:"+requestURI);
		...
		if (!errorMsgMap.isEmpty()) {
			RequestDispatcher rd = request.getRequestDispatcher("generalService/memberLogin.jsp");
		...
		MemberVO mvo = ms.login(userId, password);
		if (mvo != null) {
